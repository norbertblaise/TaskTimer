...
public class AddEditActivityFragment extends Fragment {
    ...
    public AddEditActivityFragment() {
        Log.d(TAG, "AddEditActivityFragment: contructtor called");
    }
    ...
    public void onAttach(Context context) {
        ...
        //Activities containing this fragment must implement callbacks
        Activity activity = getActivity();
        if (!(activity instanceof OnSaveClicked)){
            throw new ClassCastException(activity.getClass().getSimpleName()
            + " must implement AddEditActivity Fragment.OnSaveClicked interface");
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // theres not reason to hit the databse unless that has  happened
