...
import com.example.norbertlukwayi.tasktimer.debug.TestData;
...
public class MainActivity extends AppCompatActivity implements CursorRecyclerViewAdapter.OnTaskClickListener,
    ...
    public void onSaveClicked() {
        ...
        if (!mTwoPane){
            //We've just remoeved the editing fragment, so hide the frame
            addEditLayout.setVisibility(View.GONE);

            //make sure main activty frame is visible
            mainFragment.setVisibility(View.VISIBLE);
        }
    }
            ...
            about_url.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try{
                        ...
                        Toast.makeText(MainActivity.this, "No browser application found, cannot visit worldwide web", Toast.LENGTH_LONG).show();
                    }
                }
            });
        }
    ...
    private void taskEditRequest(Task task){
        ...
        Log.d(TAG, "taskEditRequest: twoPaneMode");
         ...
         if(!mTwoPane){
             ...
             //hide the lefthand fragment and show the right hand frame
             View mainFragment = findViewById(R.id.fragment);
             View addEditLayout = findViewById(R.id.task_details_container);
             mainFragment.setVisibility(View.GONE);
             addEditLayout.setVisibility(View.VISIBLE);
    ...
    public void onPositiveDialogResult(int dialogId, Bundle args) {
        ...
        switch(dialogId){
            case DIALOG_ID_DELETE:
                ...
                if (BuildConfig.DEBUG && taskId == 0  ) throw new AssertionError("Task id is0");
            ...
            case DIALOG_ID_CANCEL_EDIT_UP:
                ...
                if (fragment!= null){
                    ...
                    getSupportFragmentManager().beginTransaction()
                            ...
                            .commit();
                    if (mTwoPane){
                        //In landScape, quit only if the back button is pressed
                        ...
                        //and make sure the MainActivity fragment is visible
                        mainFragment.setVisibility(View.VISIBLE);
                    }
                }else{
                    // not editing, so quit reqardless of our intention
                    finish();
                }
                break;
        }
